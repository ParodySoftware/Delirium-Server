...
public class DBUtils {
	...
	public List<Posting> getPostingsBefore(Date time, int limit) {

		TypedQuery<Posting> query = em.
		  createQuery("select p from Posting p where p.created <= :Date order by p.created", Posting.class);
	...
	private static Map<Integer, Class<?>> getSQLToJavaTypesMap()
